...
function Kitchen() {
  ...
  return (
    ...
    // </div>
    <section className="kitchenSec">
        <div className="kitchenContainer">
            <div className="kitchenwelcomeDB flex">
                <div className="kitchenleftWelcome">
                    <h1 className='kitchenTitle'>Kitchen</h1>
                    <p className='kitchenTitle'>Welcome back, NAME HERE!</p>
                </div>
                <div className="kitchenrightWelcome">
                    <button className="kitchenbookAnotherGuest btn">
                        <p>Book another guest?</p>
                    </button>
                </div>
            </div>
            <div className="kitchenguestList">
                <h3><i>Guest List:</i></h3>
            </div>
            <div className="kitchentableDiv">
                <Paper>
                    <TableContainer>
                        <Table stickyHeader>
                            <TableHead>
